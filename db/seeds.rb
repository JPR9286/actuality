...
chatroom.messages.create!(user: user1, content: "Oui, et il y aura aussi des améliorations sur les lignes de bus et de tramway.")
...
chatroom.messages.create!(user: user2, content: "Je me demande si les tarifs des transports vont augmenter pendant les jeux.")
...
chatroom.messages.create!(user: user4, content: "Le programme est intense, mais c'est incroyable ce que l'on peut apprendre en si peu de temps.")
...
chatroom.messages.create!(user: user2, content: "Absolument, ils commencent par les bases avant de passer à des concepts plus avancés.")
