...
article1.save!
article2 = Article.new(title: "Victoire 4-0 du PSG dans le classico contre marseille")
article2.category = Category.all.sample
article2.save!
article3 = Article.new(title: "Vers un Avenir Durable : Initiatives Écologiques et Changements Indispensables pour la Préservation de notre Planète.")
article3.category = Category.all.sample
article3.save!
article4 = Article.new(title: "Les Innovations Technologiques qui Transforment Notre Quotidien : De la 5G à l'Intelligence Artificielle.")
article4.category = Category.all.sample
article4.save!
article5 = Article.new(title: "L'Évolution du Fitness : Tendances Actuelles et Innovations qui Redéfinissent l'Entraînement Sportif.")
article5.category = Category.all.sample
article5.save!
article6 = Article.new(title: "Civilisations Anciennes : À la Découverte des Mystères de l'Égypte Antique.")
article6.category = Category.all.sample
article6.save!
article7 = Article.new(title: "Plongée Dans l'Univers Virtuel : Les Jeux Vidéo les Plus Attendus de l'Année et les Tendances Émergentes.")
article7.category = Category.all.sample
article7.save!
article8 = Article.new(title: "JO-2024 : le prix du ticket de métro va quasiment doubler durant l'été")
article8.category = Category.all.sample
article8.save!
article9 = Article.new(title: "Japon Éternel : Une Odyssée Culturelle à Travers les Traditions, la Technologie et la Beauté Naturelle.")
article9.category = Category.all.sample
article9.save!
article10 = Article.new(title: "Facebook et Instagram payants : une plainte pour infraction au droit européen des données personnelles")
